...
RSpec.describe AaServiceBus do
  describe 'GET /' do
    before { get '/', headers: { 'HTTP_AUTHORIZATION' => '' } }
      ...
      context 'when the AA API is up' do
        context 'and the user is a member' do
          ...
          it 'responds true' do
            ...
            get '/check_member/foo@bar.com', headers: { 'HTTP_AUTHORIZATION' => ENV['AA_API_TOKEN'] }
        ...
        context 'and the user is not a member' do
          ...
          it 'responds false' do
            ...
            get '/check_member/bla@xpto.com', headers: { 'HTTP_AUTHORIZATION' => ENV['AA_API_TOKEN'] }
            expect(last_response.status).to eq 200
